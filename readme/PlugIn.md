...
[Программная реализация](../NBA.R) 

<img src="pics/GNB.png" width="500">

***Линии уровня многомерного распределения***

[Программная реализация](https://zoncker.shinyapps.io/LLines/), в интерфейсе доступна визуализация всех особых случаев с описанием. (Спасибо Shiny за бесплатный хост приложений).
```R
